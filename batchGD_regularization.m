function [theta,cost_history,counter,accu_plot] = batchGD_regularization(x,y,theta,alpha,isRaw,lambda)
...
while flag
    ...
    current_cost = computeCost_regularization(x,y,theta,lambda);
