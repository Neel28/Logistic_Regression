function [ans,th] = cv_regularization(xtr,ytr,xte,yte,k,lambda)
...
for i=1:k
    ...
    initial_theta;
    alpha=0.0001;
    [theta,cost_history,counter,accu_plot] = batchGD_regularization(dtrain,ltrain,initial_theta,alpha,0,lambda);
